...
namespace Mint
{
    public struct NilClass : iObject
    {
        ...
        public static implicit operator bool (NilClass self)
            => false;


        public static bool operator ==(NilClass self, object other)
            => self.Equals(other);
        ...
        public static bool IsNil(object other)
            => other == null || other is NilClass;
